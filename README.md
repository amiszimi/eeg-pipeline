...
This project implements a full EEG analysis workflow from raw data to meaningful neuroscience results:
...
Different frequency bands show distinct spatial patterns. Alpha power (8-12 Hz) is strongest over the occipital (visual) cortex — a classic neuroscience finding first discovered in 1929!
...
| **Signal Processing** | Filtering (FIR/IIR), Fourier analysis, Power spectral density |
| **Neuroscience Tools** | MNE-Python, ICA decomposition |
| **Data Analysis** | ERP extraction, time-frequency analysis, statistical comparisons |
| **Software Engineering** | Modular code design, documentation, version control |
...
Aspiring neuroengineering professional with interests in neuromodulation and computational neuroscience.
